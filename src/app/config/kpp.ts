...
export const kpp: Test = {
  ...
  questions: [{
    question: 'Jedną z przyczyn wstrząsu hipowolemicznego jest:',
    answers: [
      {
    ...
    {
      question: 'Osobę poszkodowaną zabezpieczamy przed wychłodzeniem folią „NRC". Należy ja ułożyć:',
      answers: [
        {
    ...
    {
      question: 'Pozycja przeciwwstrząsowa polega na ułożeniu poszkodowanego:',
      answers: [
        {
    ...
    {
      question: 'Niepokój, szybki oddech, brak wyczuwalnego tętna na tętnicy promieniowej, nawrót kapilarny >2sek, bladość powłok skórnych, zimny pot. Te objawy mogą być oznaką:',
      answers: [
        {
    ...
    {
      question: 'Czas nawrotu kapilarnego (CRT - capillary refill time).',
      answers: [
        {
    ...
    {
      question: 'Będąc świadkiem napadu drgawek u chorego na ulicy należy:',
      answers: [
        {
    ...
    {
      question: 'Wskaż zdanie fałszywe dotyczące napadu drgawkowego:',
      answers: [
        {
    ...
    {
      question: 'Drgawki mogą występować przy:',
      answers: [
        {
    ...
    {
      question: 'Wskaż zdanie prawdziwe dotyczące występowania śpiączki u chorego na cukrzycę:',
      answers: [
        {
    ...
    {
      question: 'U osoby, która jest nieprzytomna, śpiączkę cukrzycową możesz podejrzewać na podstawie:',
      answers: [
        {
    ...
    {
      question: 'Wskaż prawdziwe stwierdzenie dotyczące powikłań dotyczących cukrzycy:',
      answers: [
        {
    ...
    {
      question: 'Na przystanku autobusowym leży na brzuchu mężczyzna w wieku ok. 55 lat. Co robisz?',
      answers: [
        {
    ...
    {
      question: 'W autobusie siedzi mężczyzna, skarżący się na piekący ból w kl. piersiowej, jest blady i spocony, oddycha szybko. Jakie będzie Twoje działanie?',
      answers: [
        {
    ...
    {
      question: 'U osoby, która uskarżała się na ból w kl. piersiowej doszło w Twojej obecności do utraty przytomności i osunięcia na podłogę. Co robisz?',
      answers: [
        {
    ...
    {
      question: 'U nieprzytomnej osoby dorosłej brak oddechu stanowi podstawę do podjęcia resuscytacji w schemacie:',
      answers: [
        {
    ...
    {
      question: 'Do często spotykanych objawów zawału mięśnia sercowego należą:',
      answers: [
        {
    ...
    {
      question: 'Częstym powikłaniem uciśnięć klatki piersiowej u osoby z zatrzymaniem oddechu i krążenia, jest:',
      answers: [
        {
    ...
    {
      question: 'Przy trudnościach w oddychaniu pacjenta przebywającego w strefie zadymienia należy:',
      answers: [
        {
    ...
    {
      question: 'Oddechu zastępczego metodą usta - usta nie wolno wykonywać gdy:',
      answers: [
        {
    ...
    {
      question: 'Przy podejrzeniu zatrucia cyjanowodorem poszkodowanego (możliwy wyczuwalny zapach gorzkich migdałów), który ma ślady wymiocin na ustach możemy:',
      answers: [
        {
    ...
    {
      question: 'Najczęstszą przyczyną zgonu u osób, które uległy zatruciu substancjami wpływającymi na funkcjonowanie centralnego układu nerwowego jest:',
      answers: [
        {
    ...
    {
      question: 'W stosunku do osoby, która w wyniku zatrucia straciła przytomność podejmiesz następujące czynności:',
      answers: [
        {
    ...
    {
      question: 'Wskaż prawidłową kolejność postępowania z osobą, która straciła przytomność podczas kąpieli w łazience w której jest piecyk gazowy: 1. wstrzymując oddech zamkniesz dopływ gazu i otworzysz okno w łazience. 2. ocenisz czynności życiowe. 3. wyniesiesz poszkodowanego poza strefę zagrożenia. 4. wezwiesz Zespół Ratownictwa Medycznego i straż pożarną następnie udzielisz pomocy w razie potrzeby. 5. opuścisz pomieszczenie by Tobie nic się nie stało i wezwiesz pomoc. Prawidłowa odpowiedź to: ',
      answers: [
        {
          answer: 'A. 5,4.',
          isCorrect: false,
    ...
    {
      question: 'Wskaż zdanie fałszywe dotyczące informacji o tlenku węgla:',
      answers: [
        {
    ...
    {
      question: 'Po wyjściu z kąpieli z łazienki w której jest piecyk gazowy, osoba zgłasza nudności oraz zawroty głowy, zaczyna wymiotować. Jakie jest Twoje postępowanie?',
      answers: [
        {
    ...
    {
      question: 'Pulsoksymetria jako metoda pomiarowa do czego jest wykorzystywana?',
      answers: [
        {
    ...
    {
      question: 'Osobie, która uległa podtopieniu, po wyjęciu z wody należy:',
      answers: [
        {
    ...
    {
      question: 'Jednym z pierwszych objawów zatrucia tlenkiem węgla jest/są:',
      answers: [
        {
    ...
    {
      question: 'Ratując osobę podtopioną w wodzie o niskiej temperaturze należy pamiętać że:',
      answers: [
        {
    ...
    {
      question: 'W przypadku podtopienia prowadzenie oddechu zastępczego należy rozpocząć:',
      answers: [
        {
    ...
    {
      question: 'Stosując regułę „9" można ustalić, że oparzenie obejmujące obie kończyny dolne u osoby dorosłej stanowi następujący procent powierzchni całego ciała:',
      answers: [
        {
          answer: 'A. 18%.',
          isCorrect: false,
    ...
    {
      question: 'Powierzchnia dłoni u dorosłego (reguła dłoni) to:',
      answers: [
        {
    ...
    {
      question: 'Przy oparzeniu parą wodną obu rąk należy:',
      answers: [
        {
    ...
    {
      question: 'Wskaż pierwszą czynność przy poszkodowanym porażeniem prądem po odłączeniu źródła napięcia:',
      answers: [
        {
    ...
    {
      question: 'O oparzeniu dróg oddechowych i zatruciu wziewnym mogą świadczyć następujące objawy:',
      answers: [
        {
    ...
    {
      question: 'Jaka jest najpoważniejsza wczesna komplikacja porażenia prądem elektrycznym zmiennym?',
      answers: [
        {
    ...
    {
      question: 'Brak odczuwania bólu w miejscu urazu, stwierdzisz przy oparzeniach:',
      answers: [
        {
          answer: 'A. I°.',
          isCorrect: false,
    ...
    {
      question: 'Wskaż jaki procent powierzchni ciała stanowi powierzchnia głowy odpowiednio u osoby dorosłej i niemowlęcia (według reguły 9):',
      answers: [
        {
          answer: 'A. 18%, 16%.',
          isCorrect: false,
    ...
    {
      question: 'Po spożyciu przez poszkodowanego dużej ilości leków w celach samobójczych należy jak najszybciej:',
      answers: [
        {
    ...
    {
      question: 'Osobę po spożyciu dużej ilości alkoholu należy:',
      answers: [
        {
    ...
    {
      question: 'Czy jest różnica w postępowaniu z osobą oparzoną silnym kwasem lub silną zasadą? (w postępowaniu na poziomie kwalifikowanej pierwszej pomocy)',
      answers: [
        {
    ...
    {
      question: 'Oparzenie I° charakteryzuje się:',
      answers: [
        {
    ...
    {
      question: 'Oparzenie II° charakteryzuje się:',
      answers: [
        {
    ...
    {
      question: 'Oparzenie III° charakteryzuje się:',
      answers: [
        {
    ...
    {
      question: 'Hipertermia to stan w którym występuje: ',
      answers: [
        {
    ...
    {
      question: 'Na wycieczce w lesie doszło do ukąszenia przez żmiję jednego z uczestników. Należy natychmiast:',
      answers:
      [
        {
    ...
    {
      question: '5 letnie dziecko w trakcie zabawy w ogrodzie zostało ukąszone wielokrotnie przez pszczoły. Należy natychmiast:',
      answers: [
        {
    ...
    {
      question: ' Hipoksja to stan w którym:',
      answers: [
        {
    ...
    {
      question: 'Hipotonia ortostatyczna to stan w którym:',
      answers: [
        {
    ...
    {
      question: 'W masywnych krwotokach (duża utrata krwi w krótkim czasie), w pierwszej fazie spodziewamy się u poszkodowanego: 1. zaburzeń świadomości; 2. przyśpieszonego tętna; 3. zaczerwienienia skóry; 4. sinicy twarzy. Prawidłowa odpowiedź to:',
      answers: [
        {
          answer: 'A. 1, 2, 3.',
          isCorrect: false,
    ...
    {
      question: 'Przy oparzeniach elektrycznych najbardziej zagrażające dla poszkodowanego są:',
      answers: [
        {
    ...
    {
      question: 'U nieprzytomnego poszkodowanego, po upadku ze schodów, bez krwotoków zewnętrznych, z widocznym powierzchniowym otarciem skóry głowy, z zachowanym własnym oddechem i tętnem, działania pilne należy wykonać w następującej kolejności: 1. tlenoterapia (jeżeli są wskazania). 2. odkażenie rany. 3. ręczna stabilizacja kręgosłupa szyjnego, ocena oddechu. 4. ułożenie w pozycji przeciwwstrząsowej. 5. założenie opatrunku osłaniającego. Prawidłowa odpowiedź to:',
      answers: [
        {
        answer: 'A 3,1.',
        isCorect: true,
    ...
    {
      question: 'Spośród niżej wymienionych czynności ratowniczych, wskaż priorytetowe:',
      answers: [
        {
    ...
    {
      question: 'Ranę kłutą klatki piersiowej na miejscu zdarzenia zaopatrzysz:',
      answers: [
        {
    ...
    {
      question: 'U poszkodowanego w wyniku wypadku, stwierdzono szereg obrażeń i objawów. Zaznacz, który objaw (lub grupa objawów), albo obrażenie Twoim zdaniem jest najbardziej niepokojący i może wskazywać na potencjalne zagrożenie życia poszkodowanego:',
      answers: [
        {
    ...
    {
      question: 'Wyciek płynu mózgowo-rdzeniowego i/lub krwawienie z uszu u poszkodowanego po urazie:',
      answers: [
        {
    ...
    {
      question: 'Krwotok tętniczy zaopatrujemy w pierwszej kolejności :',
      answers: [
        {
    ...
    {
      question: 'W przypadku krwotoku u poszkodowanego w pierwszej fazie występują pewne charakterystyczne objawy. Wskaż, który z niżej wymienionych objawów raczej nie wystąpi u takiego poszkodowanego:',
      answers: [
        {
    ...
    {
      question: 'W trakcie udzielania pomocy w przypadku oparzenia, miejsce urazu należy schłodzić bieżącą wodą lub użyć opatrunku hydrożelowego. Zaletami zastosowania opatrunku hydrożelowego są:',
      answers: [
        {
    ...
    {
      question: 'Najdogodniejszą pozycją dla poszkodowanych po urazie brzucha jest pozycja:',
      answers: [
        {
    ...
    {
      question: 'U poszkodowanego po urazie głowy z ucha wycieka powoli różowo podbarwiony płyn. Podaj właściwy sposób postępowania:',
      answers: [
        {
    ...
    {
      question: 'Krwotok tętniczy można próbować odróżnić od żylnego na podstawie:',
      answers: [
        {
    ...
    {
      question: 'Poszkodowany siedzi w rozbitym samochodzie, jest blady, spocony, ma przyśpieszony oddech, złamania zamknięte obu kończyn dolnych na różnych wysokościach oraz zaburzenia świadomości. Podaj prawidłowy sposób postępowania przed przybyciem Zespołu Ratownictwa Medycznego:',
      answers: [
        {
    ...
    {
      question: 'Wskaż prawidłową kolejność postępowania z poszkodowanym po urazie w wyniku wypadku samochodowego:',
      answers: [
        {
    ...
    {
      question: 'Kołnierz ortopedyczny służy do:',
      answers: [
        {
    ...
    {
      question: 'U poszkodowanego z rozległą raną powłok i obrażeniami narządów jamy brzusznej ratownik powinien:',
      answers: [
        {
    ...
    {
      question: 'Spośród wymienionych czynności, do zakresu kwalifikowanej pierwszej pomocy medycznej udzielanej przez ratowników, nie należy:',
      answers: [
        {
    ...
    {
      question: 'W masywnych krwotokach (duża utrata krwi w krótkim czasie) w pierwszej fazie, spodziewamy się u poszkodowanego:',
      answers: [
        {
    ...
    {
      question: 'W złamaniu otwartym kości udowej, któremu towarzyszy krwotok tętniczy, priorytetem ratowniczym jest:',
      answers: [
        {
    ...
    {
      question: 'Poszkodowanemu w hipotermii należy zapewnić pozycję:',
      answers: [
        {
          answer: 'A. poziomą.',
          isCorrect: false,
    ...
    {
      question: 'W razie zwichnięcia stawu należy:',
      answers: [
        {
    ...
    {
      question: 'W przypadku braku szyn Kramera, jedną z możliwych alternatyw zabezpieczenia złamanego podudzia będzie:',
      answers: [
        {
    ...
    {
      question: 'Uszkodzoną kończynę górną możesz unieruchomić:',
      answers: [
        {
    ...
    {
      question: 'Leżącego poszkodowanego po urazie kręgosłupa ratownik wyposażony w sprzęt medyczny:',
      answers: [
        {
    ...
    {
      question: 'Podejrzewasz uraz kręgosłupa w przypadku, gdy:',
      answers: [
        {
    ...
    {
      question: 'Opatrunek uciskowy stosuje się:',
      answers: [
        {
    ...
    {
      question: 'W przypadku rozpoznania wstrząsu hipowolemicznego postępowanie przeciwwstrząsowe obejmuje:',
      answers: [
        {
    ...
    {
      question: 'W postępowaniu przeciwwstrząsowym najważniejsze jest:',
      answers: [
        {
    ...
    {
      question: 'Podczas ewakuacji poszkodowanego na noszach - desce, powinny być spełnione określone warunki. Wskaż wśród niżej wymienionych stwierdzeń błędne:',
      answers: [
        {
    ...
    {
      question: 'Poszkodowanego w wypadku drogowym ewakuuje się z wnętrza pojazdu, gdy:',
      answers: [
        {
    ...
    {
      question: 'Dla ratownika różnica pomiędzy transportem a ewakuacją polega na tym, że:',
      answers: [
        {
    ...
    {
      question: 'Określona w procesie segregacji poszkodowanych w zdarzeniu masowym grupa „czerwona" to grupa o najwyższym priorytecie:',
      answers: [
        {
    ...
    {
      question: 'Zdarzenie masowe to zdarzenie o znacznej dysproporcji pomiędzy zapotrzebowaniem na medyczne działania ratownicze realizowane w trybie natychmiastowym a możliwościami:',
      answers: [
        {
    ...
    {
      question: 'Umieszczona w planie ratowniczym procedura dysponowania danego podmiotu ratowniczego oparta powinna być głównie na: 1. odległości miejsca stacjonowania podmiotu od miejsca zdarzenia; 2. przynależności administracyjnej miejsca zdarzenia; 3. teoretycznym czasie przybycia podmiotu ratowniczego na miejsce zdarzenia; 4. rodzaju zdarzenia; 5. aktualnym czasie przybycia podmiotu ratowniczego na miejsce zdarzenia. Prawidłowa odpowiedź to:',
      answers: [
        {
          answer: 'A. 1, 4.',
          isCorrect: false,
    ...
    {
      question: 'Poszkodowany wydolny krążeniowo i oddechowo z zamkniętym złamaniem podudzi, u którego po kilkunastu minutach po segregacji pierwotnej rozwinęły się objawy wstrząsu, należy do grupy:',
      answers: [
        {
    ...
    {
      question: 'W założeniach taktycznych ratownictwa medycznego w zdarzeniach na drogach, wykonanie dostępu oznacza:',
      answers: [
        {
    ...
    {
      question: 'Zadania z zakresu kwalifikowanej pierwszej pomocy realizowane przez ratowników KSRG:',
      answers: [
        {
    ...
    {
      question: 'Organizacja ratownictwa medycznego realizowanego przez podmioty KSRG nie obejmuje:',
      answers: [
        {
    ...
    {
      question: 'Czy osoba udzielająca pierwszej pomocy, kwalifikowanej pierwszej pomocy oraz podejmująca medyczne czynności ratunkowe korzysta z ochrony przewidzianej prawem?',
      answers: [
        {
    ...
    {
      question: 'Pozycja boczna ustalona ma na celu zapewnienie drożnych dróg oddechowych oraz umożliwienie swobodnego wypływu śliny i treści z jamy ustnej. Aby spełniała swoje zadanie muszą być spełnione poniższe warunki, z wyjątkiem:',
      answers: [
        {
    ...
    {
      question: 'Jesteś świadkiem jak osoba, która się krztusi traci przytomność i upada na podłogę. Dzwonisz na 112 lub 999, a następnie przystępujesz do działania w następującej kolejności:',
      answers: [
        {
    ...
    {
      question: 'Kobieta 24-letnia połknęła garść pigułek nasennych około 30-45 minut temu. Znajdujesz ją nieprzytomną, wykonującą sporadyczne, łapiące powietrze, oddechy. Jej tętno jest szybkie i dobrze wyczuwalne. Co powinieneś zrobić?',
      answers: [
        {
    ...
    {
      question: 'Udzielasz pomocy 6-letniej ofierze wypadku samochodowego, u której podejrzewasz uraz kręgosłupa szyjnego. Dziecko jest nieprzytomne, oddycha płytko, z wysiłkiem, słychać charczenie. Częstość oddechów 30 na minutę. Aby udrożnić drogi oddechowe powinieneś wykonać następujący manewr:',
      answers: [
        {
    ...
    {
      question: 'Zbliżasz się do osoby dorosłej, która leży na podłodze. Nie ma nikogo innego w pobliżu. Jak powinieneś postąpić?',
      answers: [
        {
    ...
    {
      question: 'Wskaż fałszywe stwierdzenie dotyczące pomocy tonącym:',
      answers: [
        {
    ...
    {
      question: 'U niektórych poszkodowanych nieprzytomnych, ale oddychających stosuje się pozycję bezpieczną. Wskaż stwierdzenie fałszywe:',
      answers: [
        {
    ...
    {
      question: 'Wskaż czynność, która nie jest elementem procedury udrażniania dróg oddechowych:',
      answers: [
        {
    ...
    {
      question: 'Jakie będzie Twoje postępowanie u poszkodowanego, który w wyniku wypadku samochodowego doznał urazu z raną tłuczoną głowy, z przejściową utratą świadomości i przebywa nadal w samochodzie?',
      answers: [
        {
    ...
    {
      question: 'Postępowanie z poszkodowanym, który w czasie pożaru wyskoczył z III piętra i doznał urazu kręgosłupa w odcinku piersiowo-lędźwiowym oraz jest nieprzytomny, z zachowanym oddechem i krążeniem, w pierwszej kolejności obejmuje:',
      answers: [
        {
    ...
    {
      question: 'Spośród niżej wymienionych czynności ratowniczych, wskaż czynność priorytetową u osoby nieprzytomnej:',
      answers: [
        {
          answer: 'A. opatrzenie rany oparzeniowej.',
          isCorrect: false,
    ...
    {
      question: 'Rurkę ustno-gardłową, spróbujesz zastosować:',
      answers: [
        {
    ...
    {
      question: 'W postępowaniu z nieprzytomnym dorosłym nieurazowym, wezwanie Zespołu Ratownictwa Medycznego powinno nastąpić:',
      answers: [
        {
    ...
    {
      question: 'Podczas oceny stanu neurologicznego poszkodowanego korzystamy ze skali AVPU. Co oznaczają poszczególne litery tej skali:',
      answers: [
        {
    ...
    {
      question: 'Właściwy rozmiar rurki ustno-gardłowej dla poszkodowanego nieprzytomnego wyznacza odległość:',
      answers: [
        {
    ...
    {
      question: 'W czasie prowadzenia u poszkodowanego oddechu zastępczego przy użyciu maski twarzowej i worka samorozprężalnego, należy pamiętać o dołączeniu do zestawu rezerwuaru tlenowego. Ma to na celu:',
      answers: [
        {
    ...
    {
      question: 'Wskaż prawdziwe stwierdzenie dotyczące relacji między resuscytacją krążeniowo- oddechową(RKO) i Automatyczną Defibrylacją Zewnętrzną (AED):',
      answers: [
        {
    ...
    {
      question: 'Na jakiej podstawie podejmiesz decyzję o wdrożeniu resuscytacji krążeniowo-oddechowej:',
      answers: [
        {
    ...
    {
      question: 'U dorosłych pacjentów prowadzenie resuscytacji krążeniowo-oddechowej w obserwowanym zatrzymaniu krążenia rozpoczyna się od:',
      answers: [
        {
    ...
    {
      question: 'W celu uciskania klatki piersiowej podczas resuscytacji, ręce układa się:',
      answers: [
        {
    ...
    {
      question: 'Stosunek uciśnięć do oddechów ratowniczych u osoby dorosłej powinien wynosić:',
      answers: [
        {
          answer: 'A. 50:2.',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia podstawowych czynności resuscytacyjnych, ocenę stanu poszkodowanego wykonuje się:',
      answers: [
        {
    ...
    {
      question: 'Jeżeli pierwszy oddech ratowniczy nie powoduje uniesienia się klatki piersiowej, należy wykonać następujące czynności, z wyjątkiem:',
      answers: [
        {
    ...
    {
      question: 'W przypadku stwierdzenia u pacjenta objawów łagodnej niedrożności dróg oddechowych spowodowanej prawdopodobnie obecnością ciała obcego, działania ratownika polegają na:',
      answers: [
        {
    ...
    {
      question: 'Worek samorozprężalny posiada następujące zalety, z wyjątkiem:',
      answers: [
        {
    ...
    {
      question: 'Wykonujesz resuscytację z udziałem kolegi. Jak często powinieneś uciskać klatkę piersiową?',
      answers: [
        {
    ...
    {
      question: 'Wykonujesz resuscytację u 5-letniego dziecka z zatrzymaniem czynności serca. Którą z technik ucisku klatki piersiowej powinieneś zastosować?',
      answers: [
        {
    ...
    {
      question: 'Bawisz się z dziećmi w pokoju, w którym jest dużo zabawek składających się z drobnych części. Nagle, 8-miesięczne niemowlę zaczyna się dusić. Słyszysz świst towarzyszący każdej próbie oddechu. Jego kaszel jest cichy i nieefektywny, zaczyna sinieć. Twoim zdaniem u niemowlęcia doszło do:',
      answers: [
        {
    ...
    {
      question: 'Widziałeś jak koleżanka upadła na korytarzu w pracy. Podchodząc do poszkodowanej stwierdziłeś, że jest nieprzytomna. Udrożniłeś drogi oddechowe. Aby ocenić czy nieprzytomna oddycha należy:',
      answers: [
        {
    ...
    {
      question: 'Czynności resuscytacyjne (uciski klatki piersiowej i oddechy) przerwiesz w następującej sytuacji:',
      answers: [
        {
    ...
    {
      question: 'U nieprzytomnego poszkodowanego nie stwierdzasz oddechu, ani tętna. Po rozpoczęciu resuscytacji krążeniowo-oddechowej (RKO) stwierdzasz, że doszło u niego do złamania kilku żeber. W takiej sytuacji:',
      answers: [
        {
    ...
    {
      question: 'Kierownik firmy, w której pracujesz jest 50-letnim, otyłym mężczyzną. Do tej pory nie chorował na serce. Aktualnie zaczął uskarżać się na nagły, ostry ból w klatce piersiowej, promieniujący do lewej ręki i żuchwy. Jak powinieneś postąpić?',
      answers: [
        {
    ...
    {
      question: 'Wykonujesz resuscytacje krążeniowo-oddechową (RKO) u półrocznego dziecka z zatrzymaniem czynności serca. Którą technikę ucisków klatki piersiowej powinieneś zastosować? 1. uciskanie klatki piersiowej jedną dłonią z częstotliwością około 100 uciśnięć na minutę. 2. uciskanie klatki piersiowej dwoma palcami jednej ręki tak, by ugiąć dolną połowę mostka na głębokość około 4 cm. 3. uciskanie górnego odcinka mostka dwoma palcami; 4. uciskanie klatki piersiowej 15x, a następnie wykonanie 3 wolnych wdechów; 5. uciskanie klatki piersiowej z częstotliwością około 100-120 razy na minutę. Prawidłowa odpowiedź to:',
      answers: [
        {
          answer: 'A. 1, 5.',
          isCorrect: false,
    ...
    {
      question: 'Szybkie badanie urazowe poszkodowanego w zdarzeniu pojedynczym nie powinno trwać dłużej niż:',
      answers: [
        {
          answer: 'A. 1min.',
          isCorrect: false,
    ...
    {
      question: 'Przed przystąpieniem do badania wstępnego u poszkodowanych z obrażeniami pourazowymi z zachowanymi czynnościami życiowymi, należy:',
      answers: [
        {
    ...
    {
      question: 'Poszkodowanych z obrażeniami pourazowymi obraca się podczas wymiotów:',
      answers: [
        {
    ...
    {
      question: 'Prowadzący wstępne badanie urazowe podchodzi w miarę możliwości do poszkodowanego:',
      answers: [
        {
    ...
    {
      question: 'Ocenę oddechu poszkodowanego prowadzi się przez:',
      answers: [
        {
          answer: 'A. 10 sek.',
          isCorrect: false,
    ...
    {
      question: 'Kiedy można przerwać wstępne badanie urazowe?',
      answers: [
        {
    ...
    {
      question: 'Podczas wstępnego badania urazowego przy poszkodowanym powinno być, w miarę możliwości:',
      answers: [
        {
    ...
    {
      question: 'Podczas wstępnego badania urazowego poszkodowanego, który leży na brzuchu, ale ma zachowany prawidłowy oddech:',
      answers: [
        {
    ...
    {
      question: 'Podczas wstępnego badania urazowego poszkodowanego z obrażeniami pourazowymi w pierwszej kolejności należy znaleźć:',
      answers: [
        {
          answer: 'A. złamania.',
          isCorrect: false,
    ...
    {
      question: 'Ratownik będący liderem zespołu prowadząc wstępne badanie:',
      answers: [
        {
    ...
    {
      question: 'Badanie powtórne (szczegółowe) chorego z obrażeniami pourazowymi rozpoczynamy po:',
      answers: [
        {
    ...
    {
      question: 'Szybkie badanie urazowe poszkodowanego z obrażeniami pourazowymi powinno być przeprowadzone:',
      answers: [
        {
    ...
    {
      question: 'Badanie szyi chorego z obrażeniami pourazowymi nie obejmuje:',
      answers: [
        {
    ...
    {
      question: 'Po wykonaniu szybkiego badania urazowego i założeniu ewentualnych opatrunków można:',
      answers: [
        {
    ...
    {
      question: 'Wypełnione żyły szyjne mogą sugerować np.:',
      answers: [
        {
    ...
    {
      question: 'Po założeniu kołnierza ortopedycznego osobie nieprzytomnej z cechami urazu kręgosłupa w odcinku szyjnym:',
      answers: [
        {
    ...
    {
      question: 'Jeśli podczas próby stabilizacji kręgosłupa szyjnego występują opory lub bolesność, to:',
      answers: [
        {
    ...
    {
      question: 'Jeśli podczas badania chorego z obrażeniami pourazowymi głowy zauważysz wyciekające płyny z uszu i nosa, to:',
      answers: [
        {
    ...
    {
      question: 'Nawrót kapilarny badamy uciskając:',
      answers: [
        {
    ...
    {
      question: 'Podczas badania poszkodowanego z obrażeniami pourazowymi klatki piersiowej należy go:',
      answers: [
        {
    ...
    {
      question: 'Podczas badania chorego z obrażeniami pourazowymi brzucha szukamy:',
      answers: [
        {
    ...
    {
      question: 'Podczas badania poszkodowanego leżącego na wznak z obrażeniami pourazowymi, plecy powinno zbadać się, gdy:',
      answers: [
        {
    ...
    {
      question: 'Podczas wykonywania defibrylacji:',
      answers: [
        {
    ...
    {
      question: 'Przed przyklejeniem elektrod defibrylatora:',
      answers: [
        {
    ...
    {
      question: 'W strefie przeprowadzania defibrylacji:',
      answers: [
        {
    ...
    {
      question: 'Jeśli są wskazania u podtopionych z NZK, defibrylację wykonujemy po:',
      answers: [
        {
    ...
    {
      question: 'W trakcie oczekiwania na zespół ratownictwa medycznego po pomyślnym wykonaniu defibrylacji i powrocie oznak krążenia u poszkodowanego:',
      answers: [
        {
    ...
    {
      question: 'Elektrody AED umieszczamy:',
      answers: [
        {
    ...
    {
      question: 'Wsparcie psychiczne poszkodowanego powinno być zastosowane:',
      answers: [
        {
    ...
    {
      question: 'Wskaż, co nie jest zabronione podczas udzielania wsparcia psychicznego poszkodowanemu:',
      answers: [
        {
    ...
    {
      question: 'Wskaż, co jest zabronione podczas udzielania kwalifikowanej pierwszej pomocy poszkodowanemu:',
      answers: [
        {
    ...
    {
      question: 'U poszkodowanych urazowych wsparcie psychiczne może prowadzić ratownik:',
      answers: [
        {
    ...
    {
      question: 'Od udzielających wsparcia psychicznego poszkodowany oczekuje:',
      answers: [
        {
    ...
    {
      question: 'Podchodząc do poszkodowanego pozostającego po wypadku w pojeździe ratownik powinien:',
      answers: [
        {
    ...
    {
      question: 'Po przybyciu na miejsce zdarzenia ekipy ratunkowej następuje rozpoznanie, które ma na celu:',
      answers: [
        {
    ...
    {
      question: 'W badaniu wstępnym osoby poszkodowanej bierzemy pod uwagę:',
      answers: [
        {
    ...
    {
      question: 'Stabilizując bezprzyrządowo kręgosłup szyjny należy pamiętać, aby:',
      answers: [
        {
    ...
    {
      question: 'Podczas wykonywania defibrylacji należy:',
      answers: [
        {
    ...
    {
      question: 'Wsparcie psychiczne poszkodowanych powinno:',
      answers: [
        {
    ...
    {
      question: 'Najczęstsze objawy występujące w przypadku występowania odmy opłucnowej to:',
      answers: [
        {
    ...
    {
      question: 'W przypadku złamania podudzia but zdejmujemy:',
      answers: [
        {
    ...
    {
      question: 'Przy przepływie 15 l/min zawartość butli o pojemności 2,7 litra wypełnionej tlenem sprężonym do 150 atmosfer wystarczy na:',
      answers: [
        {
    ...
    {
      question: 'U poszkodowanego nieprzytomnego w przypadku niedrożności nosa zastępczą wentylację prowadzimy:',
      answers: [
        {
    ...
    {
      question: 'Skręcenie stawu skokowego:',
      answers: [
        {
    ...
    {
      question: 'Gdy poszkodowany niedosłyszy:',
      answers: [
        {
    ...
    {
      question: 'Utrata przytomności jest niebezpieczna, ponieważ:',
      answers: [
        {
    ...
    {
      question: 'Nudności i wymioty u poszkodowanego w wypadku drogowym:',
      answers: [
        {
    ...
    {
      question: 'Jeśli podczas oceny czynności życiowych masz wątpliwości czy doszło do zatrzymania krążenia powinieneś:',
      answers: [
        {
    ...
    {
      question: 'Którą z bezprzyrządowych metod udrażniania dróg oddechowych zastosujesz w pierwszej kolejności u osoby z podejrzeniem urazu szyjnego odcinka rdzenia kręgowego?',
      answers: [
        {
    ...
    {
      question: 'Która z poniższych czynności zabezpiecza dolne drogi oddechowe przed zachłyśnięciem treścią płynną?',
      answers: [
        {
    ...
    {
      question: 'Która z poniższych metod tlenoterapii zapewnia uzyskanie około 85% stężenia tlenu w mieszaninie oddechowej?',
      answers: [
        {
    ...
    {
      question: 'Które z poniższych działań dotyczących prowadzenia wentylacji zastępczej u osoby dorosłej w trakcie resuscytacji krążeniowo-oddechowej negatywnie wpływają na jej skuteczność?',
      answers: [
        {
    ...
    {
      question: 'Które z poniższych działań negatywnie wpływa na efektywność uciśnięć klatki piersiowej obniżając skuteczność resuscytacji krążeniowo-oddechowej?',
      answers: [
        {
    ...
    {
      question: 'Które z poniższych objawów występujących u osoby dorosłej, która w trakcie jedzenia zakrztusiła się pokarmem, są charakterystyczne dla ciężkiej niedrożności dróg oddechowych? 1. bezgłośny kaszel. 2. głośny kaszel. 3. niemożność oddychania. 4. postępująca utrata przytomności. 5. możliwość swobodnego mówienia. Prawidłowa odpowiedź to:',
      answers: [
        {
          answer: 'A. 1, 3, 5.      ',
          isCorrect: false,
    ...
    {
      question: 'Które z poniższych objawów występujących u dziecka, które w trakcie jedzenia zakrztusiło się pokarmem, są charakterystyczne dla łagodnej niedrożności dróg oddechowych? 1. bezgłośny kaszel. 2. głośny kaszel. 3. sinica. 4. możliwość nabrania powietrza przed kaszlem. 5. głośny płacz. Prawidłowa odpowiedź to. ',
      answers: [
        {
          answer: 'A. 1, 3, 4.      ',
          isCorrect: false,
    ...
    {
      question: 'Które z poniższych stwierdzeń dotyczących użycia rurki ustno-gardłowej jest nieprawdziwe?',
      answers: [
        {
    ...
    {
      question: 'Miejsce uciskania klatki piersiowej podczas resuscytacji krążeniowo- oddechowej to:',
      answers: [
        {
    ...
    {
      question: 'Odgłos bulgotania u nieprzytomnej osoby leżącej na plecach jest charakterystyczny dla wystąpienia częściowej niedrożności dróg oddechowych na skutek:',
      answers: [
        {
    ...
    {
      question: 'Odgłos charczenia (chrapania) u nieprzytomnej osoby leżącej na plecach jest charakterystyczny dla wystąpienia częściowej niedrożności dróg oddechowych na skutek:',
      answers: [
        {
          answer: 'A. kurczu krtani.',
          isCorrect: false,
    ...
    {
      question: 'Odgłos świstu lub stridoru u 4-letniego dziecka może wskazywać na częściową niedrożność dróg oddechowych spowodowaną:',
      answers: [
        {
    ...
    {
      question: 'Podczas oceny czynności życiowych u 8-miesięcznego dziecka badanie tętna wykonasz na:',
      answers: [
        {
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej przez dwóch ratowników u 8-miesięcznego dziecka stosunek uciśnięć klatki piersiowej do wentylacji płuc powinien wynosić:',
      answers: [
        {
          answer: 'A. 3:1.     ',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej przez dwóch ratowników u 6 letniego dziecka stosunek uciśnięć klatki piersiowej do wentylacji płuc powinien wynosić:',
      answers: [
        {
          answer: 'A. 10:2.     ',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej u osoby dorosłej stosunek uciśnięć klatki piersiowej do wentylacji płuc powinien wynosić:',
      answers: [
        {
          answer: 'A. 15:2.     ',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej noworodka, u którego zaraz po urodzeniu (świeżorodek) nie stwierdzono oznak życia, stosunek uciśnięć klatki piersiowej do wentylacji płuc powinien wynosić:',
      answers: [
        {
          answer: 'A. 3:1.     ',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej u 6-letniego dziecka uciskanie klatki piersiowej powinno się wykonywać z częstotliwością:',
      answers: [
        {
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej przez dwóch ratowników u 7-miesięcznego dziecka uciskanie klatki piersiowej powinno się wykonywać:',
      answers: [
        {
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej przez dwóch ratowników u 8-miesięcznego dziecka uciskanie klatki piersiowej powinno się wykonywać:',
      answers: [
        {
          answer: 'A. dwoma palcami jednej ręki.',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej u 8-miesięcznego dziecka uciskanie klatki piersiowej powinno się wykonywać na głębokość:',
      answers: [
        {
    ...
    {
      question: 'Aby rozpoznać nagłe zatrzymanie krążenia u osoby dorosłej, która jest głęboko nieprzytomna konieczne jest stwierdzenie:',
      answers: [
        {
    ...
    {
      question: 'Udzielasz pomocy kobiecie w zaawansowanej ciąży, która nagle osunęła się na ziemię, jest nieprzytomna, oddycha prawidłowo z częstością 15 razy na minutę. W tej sytuacji najwłaściwsze będzie ułożenie pacjentki w pozycji:',
      answers: [
        {
    ...
    {
      question: 'W przypadku 2-letniego dziecka, które podczas jedzenia zakrztusiło się pokarmem i pomimo prób usunięcia ciała obcego nie może nabrać powietrza, straciło przytomność i upadło na ziemię, prawidłowe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'W przypadku 2-letniego dziecka, które podczas jedzenia zakrztusiło się pokarmem, jest przytomne, głośno kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'W przypadku 2-letniego dziecka, które podczas jedzenia zakrztusiło się pokarmem, jest przytomne, nie może nabrać powietrza, bezgłośnie kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'W przypadku 6-miesięcznego dziecka, które podczas jedzenia zakrztusiło się pokarmem i pomimo prób usunięcia ciała obcego nie może nabrać powietrza, straciło przytomność, jest wiotkie, prawidłowe postępowanie polega na:',
      answers: [
        {
          answer: 'A. wykonaniu 5 uciśnięć nadbrzusza.',
          isCorrect: false,
    ...
    {
      question: 'W przypadku 6-miesięcznego dziecka, które podczas jedzenia zakrztusiło się pokarmem, jest przytomne, głośno kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
          answer: 'A. wykonaniu 5 uderzeń w okolicę międzyłopatkową.',
          isCorrect: false,
    ...
    {
      question: 'W przypadku 6-miesięcznego dziecka, które podczas jedzenia zakrztusiło się pokarmem, jest przytomne, nie może nabrać powietrza, bezgłośnie kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'W przypadku dorosłej osoby, która podczas jedzenia zakrztusiła się pokarmem i pomimo prób usunięcia ciała obcego z dróg oddechowych nie może nabrać powietrza, straciła przytomność i upadła na ziemię, prawidłowe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'W przypadku dorosłej osoby, która podczas jedzenia zakrztusiła się pokarmem, jest przytomna i głośno kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'W przypadku dorosłej osoby, która podczas jedzenia zakrztusiła się pokarmem, jest przytomna, nie może nabrać powietrza, bezgłośnie kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
          answer: 'A. zachęcaniu do spontanicznego kaszlu.',
          isCorrect: false,
    ...
    {
      question: 'W przypadku kobiety będącej w 8 miesiącu ciąży, która podczas jedzenia zakrztusiła się pokarmem, jest przytomna, nie może nabrać powietrza, bezgłośnie kaszle, prawidłowe postępowanie polega na:',
      answers: [
        {
          answer: 'A. zachęcaniu do spontanicznego kaszlu.',
          isCorrect: false,
    ...
    {
      question: 'W trakcie resuscytacji krążeniowo-oddechowej kobiety w zaawansowanej ciąży, aby zmniejszyć ucisk macicy na aortę i żyłę główną dolną zaleca się:',
      answers: [
        {
    ...
    {
      question: 'W trakcie resuscytacji krążeniowo-oddechowej podczas uciskania klatki piersiowej doszło do złamania żeber. Właściwe postępowanie polega na:',
      answers: [
        {
    ...
    {
      question: 'Wybierając odpowiedni rozmiar rurki ustno-gardłowej należy kierować się:',
      answers: [
        {
    ...
    {
      question: 'Zgodnie z wytycznymi ERC termin dziecko dotyczy osób:',
      answers: [
        {
    ...
    {
      question: 'Zastosowanie rurki ustno-gardłowej w celu utrzymania drożności dróg oddechowych jest wskazane u osoby:',
      answers: [
        {
    ...
    {
      question: 'Defibrylację, przy pomocy AED, wykonuje się w:',
      answers: [
        {
    ...
    {
      question: 'Krwawiącą ranę kłutą klatki piersiowej zabezpieczysz:',
      answers: [
        {
    ...
    {
      question: 'Opatrunek hemostatyczny stosuje się gdy:',
      answers: [
        {
    ...
    {
      question: 'Właściwy rozmiar maski krtaniowej dobiera się na podstawie:',
      answers: [
        {
          answer: 'A. wzrostu',
          isCorrect: false,
    ...
    {
      question: 'Prawidłowy rozmiar rurki krtaniowej (dotyczy rozmiarów 5, 4, 3) dobiera się na podstawie:',
      answers: [
        {
          answer: 'A. wzrostu',
          isCorrect: false,
    ...
    {
      question: 'Odma opłucnowa może występować w następujących postaciach:',
      answers: [
        {
          answer: 'A. otwartej.',
          isCorrect: false,
    ...
    {
      question: 'Podczas prowadzenia resuscytacji krążeniowo-oddechowej przez jednego ratownika u 6-miesięcznego dziecka stosunek uciśnięć klatki piersiowej do wentylacji płuc powinien wynosić:',
      answers: [
        {
          answer: 'A. 3:1.       ',
          isCorrect: false,
    ...
    {
      question: 'Zgodnie z wytycznymi ERC termin niemowlę dotyczy osób:',
      answers: [
        {
          answer: 'A. o masie ciała < 50 kg.',
          isCorrect: false,
    ...
    {
      question: 'Zgodnie z wytycznymi ERC termin noworodek dotyczy osób:',
      answers: [
        {
    ...
    {
      question: 'Zgodnie z wytycznymi ERC termin „świeżorodek" dotyczy osób:',
      answers: [
        {
          answer: 'A. w wieku od pierwszego miesiąca do 1 roku życia.',
          isCorrect: false,
    ...
    {
      question: 'Wykonując defibrylacje u kobiety w zaawansowanej ciąży, należy pamiętać aby:',
      answers: [
        {
    ...
    {
      question: 'Dla dziecka powyżej pierwszego roku życia chcąc użyć AED należy:',
      answers: [
        {
    ...
    {
      question: 'Przyrządowe udrożnienie dróg oddechowych stosowane dla osoby poszkodowanej mogące być zastosowane przez ratownika kpp to:',
      answers: [
        {
    ...
    {
      question: 'Typowe objawy udaru to:',
      answers: [
        {
    ...
    {
      question: 'Najbardziej prawdopodobną przyczyną nagłego zatrzymania krążenia u osób dorosłych jest/ są:',
      answers: [
        {
          answer: 'A. uraz głowy.',
          isCorrect: false,
    ...
    {
      question: 'Najbardziej prawdopodobną przyczyną nagłego zatrzymania krążenia u dzieci jest/ są:',
      answers: [
        {
          answer: 'A. uraz głowy.',
          isCorrect: false,
    ...
    {
      question: 'Algorytm resuscytacji osoby dorosłej rozpoczniesz od próby wykonania 5 oddechów ratowniczych w sytuacji rozpoznanego:',
      answers: [
        {
          answer: 'A. uduszenia.',
          isCorrect: false,
