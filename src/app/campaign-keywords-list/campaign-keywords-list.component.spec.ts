...
import { CampaignKeywordsListComponent } from './campaign-keywords-list.component';
...
describe('Components', () => {
  describe('CampaignKeywordsListComponent', () => {
    let component: CampaignKeywordsListComponent;
    let fixture: ComponentFixture<CampaignKeywordsListComponent>;
    const initialState = {
      campaign: {
        campaign: {
          id: '1234',
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CampaignKeywordsListComponent],
        providers: [
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(CampaignKeywordsListComponent);
    ...
    describe('calculateAverageRetailHealth', () => {
      it('should exists', () => {
        expect(component.calculateAverageRetailHealth).toBeTruthy();
      });
      it('should calculate keyword average retail health of associated products', () => {
        const result = component.calculateAverageRetailHealth(sampleKeyword);
        const result2 = component.calculateAverageRetailHealth(sampleKeyword2);

        expect(result).toEqual(7);
        expect(result2).toEqual(3.8);
      });
      it('should return "-" when keyword does not have any associated products', () => {
        const result = component.calculateAverageRetailHealth(sampleKeyword3);
